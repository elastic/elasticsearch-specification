...
export {
  ...
  ClientExtendsCallbackOptions
    ...
    (0, fs_1.writeFileSync)((0, path_1.join)(__dirname, 'output.d.ts'), definitions, 'utf8');
    function generateDefinition(endpoint) {
        ...
        function isParamsRequired() {
            if (requestType == null)
                return false;
            (0, assert_1.default)(requestType.kind === 'request');
    ...
    function getType(name) {
        for (const type of model.types) {
            if (type.name.name === name.name && type.name.namespace === name.namespace) {
                ...
                (0, assert_1.default)(type.kind !== 'enum');
                (0, assert_1.default)(type.kind !== 'type_alias');
                (0, assert_1.default)(type.kind !== 'interface');
                return type;
            }
        }
        return null;
...
exports.default = createClientTypes;
