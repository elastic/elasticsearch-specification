 ...
 */
export function convert_schema_to_openapi(args, cwd) {
 ...
 * @param {string | null} [cwd]
 */
export function convert_schema_to_individual_rest_api_spec_files(args, cwd) {
    const ptr0 = passArrayJsValueToWasm0(args, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(cwd) ? 0 : passStringToWasm0(cwd, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
export function __wbg_readFileSync_691af69453e7d4ec(arg0, arg1, arg2, arg3, arg4) {
...
export function __wbg_writeFileSync_d2c5ed0808e00dc9(arg0, arg1, arg2, arg3) {
