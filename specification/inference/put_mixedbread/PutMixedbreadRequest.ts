...
/**
 * Create an Mixedbread inference endpoint.
 *
 * Create an inference endpoint to perform an inference task with the `mixedbread` service.
 * @rest_spec_name inference.put_mixedbread
