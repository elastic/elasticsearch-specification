 ...
 *
 * The region policy restricts which cloud regions inference requests are allowed to reach.
...
export interface Request extends RequestBase {
  ...
  query_parameters: {
    /**
     * If `true`, the region policy is applied even if it would deny access to inference endpoints that are currently in use by ingest pipelines or semantic text fields.
