...
class MlInferenceTrainedModelsUsage {
...
class MlInferenceIngestProcessorCountUsage {
  max: long
  sum: long
  min: long
}

class MlInferenceTrainedModelsCountUsage {
  total: long
  prepackaged: long
  other: long
  regression: long
