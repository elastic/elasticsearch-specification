...
If an endpoint has some index security prerequisites to satisfy, you can specify them here.
...
If an endpoint has some cluster security prerequisites to satisfy, you can specify them here.
