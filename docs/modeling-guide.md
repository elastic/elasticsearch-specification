...
You can see the existing tag values in [add-openapi-tags.ts](https://github.com/elastic/elasticsearch-specification/blob/main/compiler/src/steps/add-openapi-tags.ts).
