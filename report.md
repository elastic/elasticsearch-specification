...
| --- | --- | --- |
| `_types.RequestBase` | 368 | [`_types/Base.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/Base.ts#L34-L34) |
...
| `_types.Time` | 189 | [`_types/Time.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/Time.ts#L65-L71) |
| `_types.Name` | 174 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L65-L65) |
...
| `_types.Indices` | 78 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L54-L54) |
...
| `_types.ExpandWildcards` | 51 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L190-L190) |
...
| `_types.Fields` | 41 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L113-L113) |
| `_types.EpochMillis` | 38 | [`_types/Time.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/Time.ts#L30-L30) |
...
| `_types.Names` | 33 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L66-L66) |
...
| `_types.ByteSize` | 29 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L81-L82) |
...
| `_types.ShardStatistics` | 23 | [`_types/Stats.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/Stats.ts#L32-L38) |
...
| `_types.ErrorCause` | 20 | [`_types/Errors.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/Errors.ts#L25-L48) |
| `_types.Ids` | 19 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L49-L49) |
...
| `_types.WaitForActiveShards` | 18 | [`_types/common.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/common.ts#L115-L116) |
...
| `_types.mapping.RuntimeFields` | 17 | [`_types/mapping/RuntimeFields.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/mapping/RuntimeFields.ts#L24-L24) |
...
| `_types.uint` | 13 | [`_types/Numeric.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_types/Numeric.ts#L23-L23) |
...
| `_global.search.ResponseBody` | 10 | [`_global/search/SearchResponse.ts`](https://github.com/elastic/elasticsearch-specification/blob/main/specification/_global/search/SearchResponse.ts#L37-L53) |
