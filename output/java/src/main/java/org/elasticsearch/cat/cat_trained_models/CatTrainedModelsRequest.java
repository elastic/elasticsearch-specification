...
public class CatTrainedModelsRequest  implements XContentable<CatTrainedModelsRequest> {
  ...
  public CatTrainedModelsRequest setFrom(Integer val) { this._from = val; return this; }
  ...
  public CatTrainedModelsRequest setSize(Integer val) { this._size = val; return this; }
