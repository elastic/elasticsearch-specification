...
public class CatCountRequest extends RequestBase<CatCountRequest> implements XContentable<CatCountRequest> {
  ...
  public CatCountRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatCountRequest::setMasterTimeout, MASTER_TIMEOUT);
