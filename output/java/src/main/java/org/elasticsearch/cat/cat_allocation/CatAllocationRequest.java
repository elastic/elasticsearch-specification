...
public class CatAllocationRequest extends RequestBase<CatAllocationRequest> implements XContentable<CatAllocationRequest> {
  ...
  public CatAllocationRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatAllocationRequest::setMasterTimeout, MASTER_TIMEOUT);
