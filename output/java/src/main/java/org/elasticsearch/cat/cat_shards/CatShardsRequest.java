...
public class CatShardsRequest extends RequestBase<CatShardsRequest> implements XContentable<CatShardsRequest> {
  ...
  public CatShardsRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatShardsRequest::setMasterTimeout, MASTER_TIMEOUT);
