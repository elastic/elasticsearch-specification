...
public class CatThreadPoolRequest extends RequestBase<CatThreadPoolRequest> implements XContentable<CatThreadPoolRequest> {
  ...
  public CatThreadPoolRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatThreadPoolRequest::setMasterTimeout, MASTER_TIMEOUT);
