...
public class CatSnapshotsRequest extends RequestBase<CatSnapshotsRequest> implements XContentable<CatSnapshotsRequest> {
  ...
  public CatSnapshotsRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatSnapshotsRequest::setMasterTimeout, MASTER_TIMEOUT);
