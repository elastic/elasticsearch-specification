...
public class CatHealthRequest extends RequestBase<CatHealthRequest> implements XContentable<CatHealthRequest> {
  ...
  public CatHealthRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatHealthRequest::setMasterTimeout, MASTER_TIMEOUT);
