...
public class CatNodesRecord extends ICatRecord implements XContentable<CatNodesRecord> {
  ...
  private int _fileDescriptorCurrent;
  private boolean _fileDescriptorCurrent$isSet;
  public int getFileDescriptorCurrent() { return this._fileDescriptorCurrent; }
  public CatNodesRecord setFileDescriptorCurrent(int val) {
    this._fileDescriptorCurrent = val;
    _fileDescriptorCurrent$isSet = true;
    return this;
  }

  static final ParseField FILE_DESCRIPTOR_MAX = new ParseField("file_descriptor_max");
  private int _fileDescriptorMax;
  private boolean _fileDescriptorMax$isSet;
  public int getFileDescriptorMax() { return this._fileDescriptorMax; }
  public CatNodesRecord setFileDescriptorMax(int val) {
    this._fileDescriptorMax = val;
    _fileDescriptorMax$isSet = true;
    return this;
  }

  static final ParseField FILE_DESCRIPTOR_PERCENT = new ParseField("file_descriptor_percent");
  private int _fileDescriptorPercent;
  private boolean _fileDescriptorPercent$isSet;
  public int getFileDescriptorPercent() { return this._fileDescriptorPercent; }
  public CatNodesRecord setFileDescriptorPercent(int val) {
    this._fileDescriptorPercent = val;
    _fileDescriptorPercent$isSet = true;
    return this;
  }
