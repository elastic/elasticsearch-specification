...
public class CatNodeAttributesRequest extends RequestBase<CatNodeAttributesRequest> implements XContentable<CatNodeAttributesRequest> {
  ...
  public CatNodeAttributesRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatNodeAttributesRequest::setMasterTimeout, MASTER_TIMEOUT);
