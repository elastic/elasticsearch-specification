...
public class CatTemplatesRequest extends RequestBase<CatTemplatesRequest> implements XContentable<CatTemplatesRequest> {
  ...
  public CatTemplatesRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(CatTemplatesRequest::setMasterTimeout, MASTER_TIMEOUT);
