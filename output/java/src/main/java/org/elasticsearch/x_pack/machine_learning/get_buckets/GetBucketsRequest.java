...
public class GetBucketsRequest extends RequestBase<GetBucketsRequest> implements XContentable<GetBucketsRequest> {
  ...
  public GetBucketsRequest setAnomalyScore(double val) {
  ...
  public GetBucketsRequest setSort(String val) { this._sort = val; return this; }
