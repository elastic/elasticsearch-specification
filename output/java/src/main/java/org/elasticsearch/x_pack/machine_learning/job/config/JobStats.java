...
public class JobStats  implements XContentable<JobStats> {
  ...
  public String getOpenTime() { return this._openTime; }
  public JobStats setOpenTime(String val) { this._openTime = val; return this; }
  ...
  public void toXContentInternal(XContentBuilder builder, ToXContent.Params params) throws IOException {
    ...
    if (_openTime != null) {
      builder.field(OPEN_TIME.getPreferredName(), _openTime);
    }
    if (_state != null) {
  ...
  static {
    ...
    PARSER.declareString(JobStats::setOpenTime, OPEN_TIME);
