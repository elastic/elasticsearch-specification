...
public class RollupSearchRequest extends RequestBase<RollupSearchRequest> implements XContentable<RollupSearchRequest> {
  ...
  public RollupSearchRequest setSize(int val) {
    this._size = val;
    _size$isSet = true;
    return this;
  }
