...
public class Job  implements XContentable<Job> {
  ...
  public Job setBackgroundPersistInterval(String val) { this._backgroundPersistInterval = val; return this; }
  ...
  public Job setModelSnapshotRetentionDays(long val) {
  ...
  public Job setRenormalizationWindowDays(long val) {
  ...
  public Job setResultsRetentionDays(long val) {
  ...
  static {
    ...
    PARSER.declareString(Job::setBackgroundPersistInterval, BACKGROUND_PERSIST_INTERVAL);
