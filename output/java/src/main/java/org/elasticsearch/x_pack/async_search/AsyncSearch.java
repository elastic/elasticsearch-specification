...
public class AsyncSearch<TDocument>  implements XContentable<AsyncSearch<TDocument>> {
  ...
  public AsyncSearch<TDocument> setMaxScore(Double val) { this._maxScore = val; return this; }
  ...
  public AsyncSearch<TDocument> setNumReducePhases(Long val) { this._numReducePhases = val; return this; }
  ...
  public AsyncSearch<TDocument> setTook(Long val) { this._took = val; return this; }
