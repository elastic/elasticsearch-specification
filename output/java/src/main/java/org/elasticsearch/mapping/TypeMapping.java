...
public class TypeMapping  implements XContentable<TypeMapping> {
  ...
  public TypeMapping setDynamic(Union2<Boolean, DynamicMapping> val) { this._dynamic = val; return this; }
  ...
  public TypeMapping setProperties(NamedContainer<String, IProperty> val) { this._properties = val; return this; }
  ...
  static {
    ...
    PARSER.declareObject(TypeMapping::setDynamic, (p, t) ->  new Union2<Boolean, DynamicMapping>(), DYNAMIC);
    ...
    PARSER.declareObject(TypeMapping::setProperties, (p, t) -> new NamedContainer<>(n -> () -> n,pp -> IProperty.PARSER.apply(pp, null)), PROPERTIES);
