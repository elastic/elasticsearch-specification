...
public class SearchAsYouTypeProperty extends CorePropertyBase implements XContentable<SearchAsYouTypeProperty> {
  ...
  public SearchAsYouTypeProperty setMaxShingleSize(int val) {
