...
public class AggregationContainer  implements XContentable<AggregationContainer> {
  ...
  public AggregationContainer setAggregations(NamedContainer<String, AggregationContainer> val) { this._aggregations = val; return this; }
  ...
  public AggregationContainer setFilter(QueryContainer val) { this._filter = val; return this; }
  ...
  private NamedContainer<String, Union3<String, Number, Boolean>> _meta;
  public NamedContainer<String, Union3<String, Number, Boolean>> getMeta() { return this._meta; }
  public AggregationContainer setMeta(NamedContainer<String, Union3<String, Number, Boolean>> val) { this._meta = val; return this; }
  ...
  static {
    ...
    PARSER.declareObject(AggregationContainer::setAggregations, (p, t) -> new NamedContainer<>(n -> () -> n,pp -> AggregationContainer.PARSER.apply(pp, null)), AGGREGATIONS);
    ...
    PARSER.declareObject(AggregationContainer::setFilter, (p, t) -> QueryContainer.PARSER.apply(p, t), FILTER);
    ...
    PARSER.declareObject(AggregationContainer::setMeta, (p, t) -> new NamedContainer<>(n -> () -> n,null /* TODO Union3<String, Number, Boolean> */), META);
