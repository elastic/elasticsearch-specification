...
public class TopHitsAggregation  implements XContentable<TopHitsAggregation> {
  ...
  public TopHitsAggregation setDocvalueFields(List<String> val) { this._docvalueFields = val; return this; }
  ...
  public TopHitsAggregation setFrom(int val) {
    this._from = val;
    _from$isSet = true;
    return this;
  }
  ...
  public TopHitsAggregation setSize(int val) {
    this._size = val;
    _size$isSet = true;
    return this;
  }
  ...
  private Union2<String, List<SingleKeyDictionary<Union2<Sort, SortOrder>>>> _sort;
  public Union2<String, List<SingleKeyDictionary<Union2<Sort, SortOrder>>>> getSort() { return this._sort; }
  public TopHitsAggregation setSort(Union2<String, List<SingleKeyDictionary<Union2<Sort, SortOrder>>>> val) { this._sort = val; return this; }
  ...
  public TopHitsAggregation setSource(Union2<Boolean, SourceFilter> val) { this._source = val; return this; }
  ...
  public TopHitsAggregation setStoredFields(List<String> val) { this._storedFields = val; return this; }
  ...
  public TopHitsAggregation setSeqNoPrimaryTerm(Boolean val) { this._seqNoPrimaryTerm = val; return this; }
  ...
  static {
    PARSER.declareStringArray(TopHitsAggregation::setDocvalueFields, DOCVALUE_FIELDS);
    ...
    PARSER.declareObject(TopHitsAggregation::setSort, (p, t) ->  new Union2<String, List<SingleKeyDictionary<Union2<Sort, SortOrder>>>>(), SORT);
    PARSER.declareObject(TopHitsAggregation::setSource, (p, t) ->  new Union2<Boolean, SourceFilter>(), SOURCE);
    PARSER.declareStringArray(TopHitsAggregation::setStoredFields, STORED_FIELDS);
    ...
    PARSER.declareBoolean(TopHitsAggregation::setSeqNoPrimaryTerm, SEQ_NO_PRIMARY_TERM);
  }
