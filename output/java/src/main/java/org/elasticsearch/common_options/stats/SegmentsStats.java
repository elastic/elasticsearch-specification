...
public class SegmentsStats  implements XContentable<SegmentsStats> {
  ...
  public SegmentsStats setCount(long val) {
    this._count = val;
    _count$isSet = true;
    return this;
  }
  ...
  public SegmentsStats setDocValuesMemoryInBytes(long val) {
  ...
  public SegmentsStats setFixedBitSetMemoryInBytes(long val) {
  ...
  private boolean _indexWriterMaxMemoryInBytes$isSet;
  public long getIndexWriterMaxMemoryInBytes() { return this._indexWriterMaxMemoryInBytes; }
  public SegmentsStats setIndexWriterMaxMemoryInBytes(long val) {
    this._indexWriterMaxMemoryInBytes = val;
    _indexWriterMaxMemoryInBytes$isSet = true;
    return this;
  }
  ...
  public SegmentsStats setIndexWriterMemoryInBytes(long val) {
  ...
  public SegmentsStats setMaxUnsafeAutoIdTimestamp(long val) {
  ...
  public SegmentsStats setMemoryInBytes(long val) {
  ...
  public SegmentsStats setNormsMemoryInBytes(long val) {
  ...
  public SegmentsStats setPointsMemoryInBytes(long val) {
  ...
  public SegmentsStats setStoredFieldsMemoryInBytes(long val) {
  ...
  public SegmentsStats setTermsMemoryInBytes(long val) {
  ...
  public SegmentsStats setTermVectorsMemoryInBytes(long val) {
  ...
  public SegmentsStats setVersionMapMemoryInBytes(long val) {
  ...
  public void toXContentInternal(XContentBuilder builder, ToXContent.Params params) throws IOException {
    ...
    if (_indexWriterMaxMemoryInBytes$isSet) {
