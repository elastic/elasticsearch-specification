...
public class RestoreRequest extends RequestBase<RestoreRequest> implements XContentable<RestoreRequest> {
  
  static final ParseField MASTER_TIMEOUT = new ParseField("master_timeout");
  private String _masterTimeout;
  public String getMasterTimeout() { return this._masterTimeout; }
  public RestoreRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }
  ...
  static {
    PARSER.declareString(RestoreRequest::setMasterTimeout, MASTER_TIMEOUT);
