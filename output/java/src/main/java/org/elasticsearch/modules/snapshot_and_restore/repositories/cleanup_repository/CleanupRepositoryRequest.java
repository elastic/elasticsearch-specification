...
public class CleanupRepositoryRequest extends RequestBase<CleanupRepositoryRequest> implements XContentable<CleanupRepositoryRequest> {
  
  static final ParseField MASTER_TIMEOUT = new ParseField("master_timeout");
  private String _masterTimeout;
  public String getMasterTimeout() { return this._masterTimeout; }
  public CleanupRepositoryRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }

  static final ParseField TIMEOUT = new ParseField("timeout");
  private String _timeout;
  public String getTimeout() { return this._timeout; }
  public CleanupRepositoryRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  static {
    PARSER.declareString(CleanupRepositoryRequest::setMasterTimeout, MASTER_TIMEOUT);
    PARSER.declareString(CleanupRepositoryRequest::setTimeout, TIMEOUT);
  }
