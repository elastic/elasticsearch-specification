...
public class ReindexRethrottleRequest extends RequestBase<ReindexRethrottleRequest> implements XContentable<ReindexRethrottleRequest> {
  ...
  public ReindexRethrottleRequest setRequestsPerSecond(long val) {
