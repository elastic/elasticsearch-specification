...
public class MultiTermVectorsRequest extends RequestBase<MultiTermVectorsRequest> implements XContentable<MultiTermVectorsRequest> {
  
  static final ParseField FIELDS = new ParseField("fields");
  private List<String> _fields;
  public List<String> getFields() { return this._fields; }
  public MultiTermVectorsRequest setFields(List<String> val) { this._fields = val; return this; }
  ...
  public MultiTermVectorsRequest setVersion(long val) {
    this._version = val;
    _version$isSet = true;
    return this;
  }
  ...
  static {
    PARSER.declareStringArray(MultiTermVectorsRequest::setFields, FIELDS);
