...
public class DeleteByQueryRequest extends RequestBase<DeleteByQueryRequest> implements XContentable<DeleteByQueryRequest> {
  ...
  public DeleteByQueryRequest setFrom(long val) {
    this._from = val;
    _from$isSet = true;
    return this;
  }
  ...
  public DeleteByQueryRequest setRequestsPerSecond(long val) {
  ...
  public DeleteByQueryRequest setScroll(String val) { this._scroll = val; return this; }
  ...
  public DeleteByQueryRequest setScrollSize(long val) {
  ...
  public DeleteByQueryRequest setSearchTimeout(String val) { this._searchTimeout = val; return this; }
  ...
  public DeleteByQueryRequest setSize(long val) {
    this._size = val;
    _size$isSet = true;
    return this;
  }
  ...
  public DeleteByQueryRequest setSlices(long val) {
    this._slices = val;
    _slices$isSet = true;
    return this;
  }
  ...
  public DeleteByQueryRequest setSourceExcludes(List<String> val) { this._sourceExcludes = val; return this; }
  ...
  public DeleteByQueryRequest setSourceIncludes(List<String> val) { this._sourceIncludes = val; return this; }
  ...
  public DeleteByQueryRequest setTerminateAfter(long val) {
  ...
  public DeleteByQueryRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  public DeleteByQueryRequest setMaxDocs(long val) {
    this._maxDocs = val;
    _maxDocs$isSet = true;
    return this;
  }
  ...
  static {
    ...
    PARSER.declareString(DeleteByQueryRequest::setScroll, SCROLL);
    PARSER.declareLong(DeleteByQueryRequest::setScrollSize, SCROLL_SIZE);
    PARSER.declareString(DeleteByQueryRequest::setSearchTimeout, SEARCH_TIMEOUT);
    ...
    PARSER.declareStringArray(DeleteByQueryRequest::setSourceExcludes, SOURCE_EXCLUDES);
    PARSER.declareStringArray(DeleteByQueryRequest::setSourceIncludes, SOURCE_INCLUDES);
    ...
    PARSER.declareString(DeleteByQueryRequest::setTimeout, TIMEOUT);
