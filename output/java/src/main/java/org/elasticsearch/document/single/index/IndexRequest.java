...
public class IndexRequest<TDocument> extends RequestBase<IndexRequest> implements XContentable<IndexRequest> {
  ...
  public IndexRequest<TDocument> setIfPrimaryTerm(long val) {
  ...
  public IndexRequest<TDocument> setIfSeqNo(long val) {
    this._ifSeqNo = val;
    _ifSeqNo$isSet = true;
    return this;
  }
  ...
  public IndexRequest<TDocument> setTimeout(String val) { this._timeout = val; return this; }

  static final ParseField VERSION = new ParseField("version");
  private long _version;
  private boolean _version$isSet;
  public long getVersion() { return this._version; }
  public IndexRequest<TDocument> setVersion(long val) {
    this._version = val;
    _version$isSet = true;
    return this;
  }
  ...
  static {
    ...
    PARSER.declareLong(IndexRequest::setIfSeqNo, IF_SEQ_NO);
    ...
    PARSER.declareString(IndexRequest::setTimeout, TIMEOUT);
