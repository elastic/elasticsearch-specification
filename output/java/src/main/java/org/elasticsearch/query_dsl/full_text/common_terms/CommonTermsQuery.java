...
public class CommonTermsQuery extends QueryBase implements XContentable<CommonTermsQuery> {
  ...
  public CommonTermsQuery setCutoffFrequency(double val) {
  ...
  static {
    ...
    PARSER.declareObject(CommonTermsQuery::setMinimumShouldMatch, (p, t) -> MinimumShouldMatch.PARSER.apply(p, t), MINIMUM_SHOULD_MATCH);
