...
public class CloneIndexRequest extends RequestBase<CloneIndexRequest> implements XContentable<CloneIndexRequest> {
  
  static final ParseField MASTER_TIMEOUT = new ParseField("master_timeout");
  private String _masterTimeout;
  public String getMasterTimeout() { return this._masterTimeout; }
  public CloneIndexRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }

  static final ParseField TIMEOUT = new ParseField("timeout");
  private String _timeout;
  public String getTimeout() { return this._timeout; }
  public CloneIndexRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  public CloneIndexRequest setAliases(NamedContainer<String, Alias> val) { this._aliases = val; return this; }
  ...
  static {
    PARSER.declareString(CloneIndexRequest::setMasterTimeout, MASTER_TIMEOUT);
    PARSER.declareString(CloneIndexRequest::setTimeout, TIMEOUT);
    PARSER.declareString(CloneIndexRequest::setWaitForActiveShards, WAIT_FOR_ACTIVE_SHARDS);
    PARSER.declareObject(CloneIndexRequest::setAliases, (p, t) -> new NamedContainer<>(n -> () -> n,pp -> Alias.PARSER.apply(pp, null)), ALIASES);
