...
public class ClearCacheRequest extends RequestBase<ClearCacheRequest> implements XContentable<ClearCacheRequest> {
  ...
  public ClearCacheRequest setFields(List<String> val) { this._fields = val; return this; }
  ...
  static {
    ...
    PARSER.declareStringArray(ClearCacheRequest::setFields, FIELDS);
