...
public class DeleteIndexRequest extends RequestBase<DeleteIndexRequest> implements XContentable<DeleteIndexRequest> {
  ...
  public DeleteIndexRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }

  static final ParseField TIMEOUT = new ParseField("timeout");
  private String _timeout;
  public String getTimeout() { return this._timeout; }
  public DeleteIndexRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(DeleteIndexRequest::setMasterTimeout, MASTER_TIMEOUT);
    PARSER.declareString(DeleteIndexRequest::setTimeout, TIMEOUT);
  }
