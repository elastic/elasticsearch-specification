...
public class PutMappingRequest extends RequestBase<PutMappingRequest> implements XContentable<PutMappingRequest> {
  ...
  public PutMappingRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }

  static final ParseField TIMEOUT = new ParseField("timeout");
  private String _timeout;
  public String getTimeout() { return this._timeout; }
  public PutMappingRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  public PutMappingRequest setDynamic(Union2<Boolean, DynamicMapping> val) { this._dynamic = val; return this; }
  ...
  public PutMappingRequest setProperties(NamedContainer<String, IProperty> val) { this._properties = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(PutMappingRequest::setMasterTimeout, MASTER_TIMEOUT);
    PARSER.declareString(PutMappingRequest::setTimeout, TIMEOUT);
    ...
    PARSER.declareObject(PutMappingRequest::setDynamic, (p, t) ->  new Union2<Boolean, DynamicMapping>(), DYNAMIC);
    ...
    PARSER.declareObject(PutMappingRequest::setProperties, (p, t) -> new NamedContainer<>(n -> () -> n,pp -> IProperty.PARSER.apply(pp, null)), PROPERTIES);
