...
public class NodeInfo  implements XContentable<NodeInfo> {
  ...
  private boolean _totalIndexingBuffer$isSet;
  public long getTotalIndexingBuffer() { return this._totalIndexingBuffer; }
  public NodeInfo setTotalIndexingBuffer(long val) {
    this._totalIndexingBuffer = val;
    _totalIndexingBuffer$isSet = true;
    return this;
  }
