...
public class ClusterHealthRequest extends RequestBase<ClusterHealthRequest> implements XContentable<ClusterHealthRequest> {
  ...
  public ClusterHealthRequest setMasterTimeout(String val) { this._masterTimeout = val; return this; }

  static final ParseField TIMEOUT = new ParseField("timeout");
  private String _timeout;
  public String getTimeout() { return this._timeout; }
  public ClusterHealthRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(ClusterHealthRequest::setMasterTimeout, MASTER_TIMEOUT);
    PARSER.declareString(ClusterHealthRequest::setTimeout, TIMEOUT);
