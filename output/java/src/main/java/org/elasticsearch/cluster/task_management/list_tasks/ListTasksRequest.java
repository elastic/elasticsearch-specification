...
public class ListTasksRequest extends RequestBase<ListTasksRequest> implements XContentable<ListTasksRequest> {
  ...
  public ListTasksRequest setTimeout(String val) { this._timeout = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(ListTasksRequest::setTimeout, TIMEOUT);
