...
public class SearchTemplateRequest extends RequestBase<SearchTemplateRequest> implements XContentable<SearchTemplateRequest> {
  ...
  public SearchTemplateRequest setScroll(String val) { this._scroll = val; return this; }
  ...
  static {
    ...
    PARSER.declareString(SearchTemplateRequest::setScroll, SCROLL);
