...
public class FieldCapabilitiesRequest extends RequestBase<FieldCapabilitiesRequest> implements XContentable<FieldCapabilitiesRequest> {
  ...
  public FieldCapabilitiesRequest setFields(List<String> val) { this._fields = val; return this; }
  ...
  static {
    ...
    PARSER.declareStringArray(FieldCapabilitiesRequest::setFields, FIELDS);
