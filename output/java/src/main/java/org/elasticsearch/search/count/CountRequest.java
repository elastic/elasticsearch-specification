...
public class CountRequest extends RequestBase<CountRequest> implements XContentable<CountRequest> {
  ...
  public CountRequest setMinScore(double val) {
    this._minScore = val;
  ...
  public CountRequest setTerminateAfter(long val) {
