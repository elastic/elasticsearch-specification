...
export type BulkFailureStoreStatus =
...
export type MsearchResponse<TDocument = unknown> =
  MsearchMultiSearchResult<TDocument>;
...
export type MsearchTemplateResponse<TDocument = unknown> =
  MsearchMultiSearchResult<TDocument>;
...
export type ScriptsPainlessExecutePainlessContext =
  | "painless_test"
  | "filter"
  | "score"
  | "boolean_field"
...
export type ErrorCause = ErrorCauseKeys & { [property: string]: any };
...
export type AggregationsInferenceAggregate =
  AggregationsInferenceAggregateKeys & { [property: string]: any };
...
export type AggregationsKeyedPercentiles = Record<
  string,
  string | double | null
>;
...
export interface AggregationsUnmappedRareTermsAggregate
  extends AggregationsMultiBucketAggregateBase<SpecUtilsVoid> {}
...
export interface AggregationsUnmappedSignificantTermsAggregate
  extends AggregationsSignificantTermsAggregateBase<SpecUtilsVoid> {}

export interface AggregationsUnmappedTermsAggregate
  extends AggregationsTermsAggregateBase<SpecUtilsVoid> {}
...
export interface AnalysisArabicNormalizationTokenFilter
...
export interface AnalysisBrazilianStemTokenFilter
  extends AnalysisTokenFilterBase {
  type: "brazilian_stem";
}
...
export type AnalysisCjkBigramIgnoredScript =
  | "han"
  | "hangul"
  | "hiragana"
  | "katakana";
...
export interface AnalysisDecimalDigitTokenFilter
  extends AnalysisTokenFilterBase {
  type: "decimal_digit";
}
...
export interface AnalysisFlattenGraphTokenFilter
  extends AnalysisTokenFilterBase {
  type: "flatten_graph";
}
...
export interface AnalysisGermanNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
...
export interface AnalysisHindiNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
...
export interface AnalysisIndicNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
...
export interface AnalysisKeywordRepeatTokenFilter
  extends AnalysisTokenFilterBase {
  type: "keyword_repeat";
}
...
export type AnalysisLowercaseTokenFilterLanguages =
  | "greek"
  | "irish"
  | "turkish";
...
export interface AnalysisPersianNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
  type: "persian_normalization";
}

export interface AnalysisPersianStemTokenFilter
  extends AnalysisTokenFilterBase {
  type: "persian_stem";
}
...
export interface AnalysisRussianStemTokenFilter
  extends AnalysisTokenFilterBase {
  type: "russian_stem";
}

export interface AnalysisScandinavianFoldingTokenFilter
  extends AnalysisTokenFilterBase {
  type: "scandinavian_folding";
}

export interface AnalysisScandinavianNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
...
export interface AnalysisSerbianNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
...
export interface AnalysisSoraniNormalizationTokenFilter
  extends AnalysisTokenFilterBase {
...
export type AnalysisStopWordLanguage =
  | "_arabic_"
  | "_armenian_"
  | "_basque_"
  | "_bengali_"
...
export interface AnalysisSynonymGraphTokenFilter
  extends AnalysisSynonymTokenFilterBase {
  type: "synonym_graph";
}

export interface AnalysisSynonymTokenFilter
  extends AnalysisSynonymTokenFilterBase {
  type: "synonym";
}

export interface AnalysisSynonymTokenFilterBase
  extends AnalysisTokenFilterBase {
  expand?: boolean;
...
export type AnalysisTokenFilterDefinition =
  ...
  | AnalysisBengaliNormalizationTokenFilter
  | AnalysisBrazilianStemTokenFilter
  | AnalysisCjkBigramTokenFilter
  | AnalysisCjkWidthTokenFilter
  | AnalysisClassicTokenFilter
  | AnalysisCommonGramsTokenFilter
  | AnalysisConditionTokenFilter
  | AnalysisCzechStemTokenFilter
  ...
  | AnalysisFlattenGraphTokenFilter
  | AnalysisFrenchStemTokenFilter
  | AnalysisGermanNormalizationTokenFilter
  | AnalysisGermanStemTokenFilter
  | AnalysisHindiNormalizationTokenFilter
  ...
  | AnalysisKeywordRepeatTokenFilter
  ...
  | AnalysisRussianStemTokenFilter
  | AnalysisScandinavianFoldingTokenFilter
...
export interface AnalysisWordDelimiterTokenFilterBase
  extends AnalysisTokenFilterBase {
...
export type MappingDenseVectorIndexOptionsType =
  | "bbq_flat"
  | "bbq_hnsw"
  | "flat"
  | "hnsw"
...
export type MappingDenseVectorSimilarity =
  | "cosine"
  | "dot_product"
  | "l2_norm"
  | "max_inner_product";
...
export type MappingProperty =
  ...
  | MappingPassthroughObjectProperty
  | MappingRankVectorProperty
...
export type QueryDslDateDecayFunction = QueryDslDateDecayFunctionKeys & {
  [property: string]:
    | QueryDslDecayPlacement<DateMath, Duration>
...
export type QueryDslGeoDecayFunction = QueryDslGeoDecayFunctionKeys & {
  [property: string]:
    | QueryDslDecayPlacement<GeoLocation, Distance>
    | QueryDslMultiValueMode;
};
...
export type QueryDslNumericDecayFunction = QueryDslNumericDecayFunctionKeys & {
  [property: string]:
    | QueryDslDecayPlacement<double, double>
    | QueryDslMultiValueMode;
};
...
export interface AsyncSearchAsyncSearchDocumentResponseBase<TDocument = unknown>
...
export type AsyncSearchGetResponse<TDocument = unknown> =
  AsyncSearchAsyncSearchDocumentResponseBase<TDocument>;
...
export type AsyncSearchSubmitResponse<TDocument = unknown> =
  AsyncSearchAsyncSearchDocumentResponseBase<TDocument>;
...
export type CatCatAnomalyDetectorColumns =
...
export type CatCatRecoveryColumn =
  | "index"
  | "i"
  | "idx"
  | "shard"
...
export type CatCatRecoveryColumns =
  | CatCatRecoveryColumn
  | CatCatRecoveryColumn[];
...
export type CatCatSegmentsColumns =
  | CatCatSegmentsColumn
  | CatCatSegmentsColumn[];
...
export type CatCatSnapshotsColumn =
  | "id"
  | "snapshot"
  | "repository"
  | "re"
...
export type CatCatSnapshotsColumns =
  | CatCatSnapshotsColumn
  | CatCatSnapshotsColumn[];

export type CatCatThreadPoolColumn =
  | "active"
  | "a"
  | "completed"
  | "c"
...
export type CatCatThreadPoolColumns =
  | CatCatThreadPoolColumn
  | CatCatThreadPoolColumn[];
...
export type ClusterStatsShardState =
  | "INIT"
  | "SUCCESS"
  | "FAILED"
  | "ABORTED"
...
export type EsqlEsqlClusterStatus =
  | "running"
  | "successful"
  | "partial"
  | "skipped"
...
export interface IndicesDataStreamLifecycleWithRollover
  extends IndicesDataStreamLifecycle {
...
export type IndicesAnalyzeExplainAnalyzeToken =
  IndicesAnalyzeExplainAnalyzeTokenKeys & { [property: string]: any };
...
export interface IndicesDeleteAliasIndicesAliasesResponseBody
...
export type IndicesDeleteAliasResponse =
  IndicesDeleteAliasIndicesAliasesResponseBody;
...
export type IndicesGetAliasNotFoundAliases =
...
export type InferenceAlibabaCloudTaskType =
  | "completion"
  | "rerank"
  | "space_embedding"
  | "text_embedding";
...
export type InferenceCohereEmbeddingType =
  | "binary"
  | "bit"
  | "byte"
  | "float"
...
export type InferenceCohereInputType =
  | "classification"
  | "clustering"
  | "ingest"
  | "search";
...
export type InferenceCohereTaskType =
  | "completion"
  | "rerank"
  | "text_embedding";
...
export type InferenceCompletionToolType =
  | string
  | InferenceCompletionToolChoice;
...
export type InferenceCustomTaskType =
  | "text_embedding"
  | "sparse_embedding"
  | "rerank"
  | "completion";
...
export type InferenceElasticsearchTaskType =
  | "rerank"
  | "sparse_embedding"
  | "text_embedding";
...
export type InferenceGoogleVertexAITaskType =
  | "rerank"
  | "text_embedding"
  | "completion"
  | "chat_completion";
...
export type InferenceHuggingFaceTaskType =
  | "chat_completion"
  | "completion"
  | "rerank"
  | "text_embedding";
...
export interface InferenceInferenceEndpointInfoAlibabaCloudAI
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeAlibabaCloudAI;
}

export interface InferenceInferenceEndpointInfoAmazonBedrock
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeAmazonBedrock;
}

export interface InferenceInferenceEndpointInfoAmazonSageMaker
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeAmazonSageMaker;
}

export interface InferenceInferenceEndpointInfoAnthropic
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeAnthropic;
}

export interface InferenceInferenceEndpointInfoAzureAIStudio
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeAzureAIStudio;
}

export interface InferenceInferenceEndpointInfoAzureOpenAI
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeAzureOpenAI;
}

export interface InferenceInferenceEndpointInfoCohere
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeCohere;
}

export interface InferenceInferenceEndpointInfoCustom
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeCustom;
}

export interface InferenceInferenceEndpointInfoDeepSeek
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeDeepSeek;
}

export interface InferenceInferenceEndpointInfoELSER
  extends InferenceInferenceEndpoint {
  inference_id: string;
...
export interface InferenceInferenceEndpointInfoGoogleAIStudio
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeGoogleAIStudio;
}

export interface InferenceInferenceEndpointInfoGoogleVertexAI
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeGoogleVertexAI;
}

export interface InferenceInferenceEndpointInfoHuggingFace
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeHuggingFace;
}

export interface InferenceInferenceEndpointInfoJinaAi
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeJinaAi;
}

export interface InferenceInferenceEndpointInfoMistral
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeMistral;
}

export interface InferenceInferenceEndpointInfoOpenAI
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeOpenAI;
}

export interface InferenceInferenceEndpointInfoVoyageAI
  extends InferenceInferenceEndpoint {
  inference_id: string;
  task_type: InferenceTaskTypeVoyageAI;
}

export interface InferenceInferenceEndpointInfoWatsonx
  extends InferenceInferenceEndpoint {
  inference_id: string;
...
export type InferenceJinaAISimilarityType =
  | "cosine"
  | "dot_product"
  | "l2_norm";
...
export type InferenceJinaAITextEmbeddingTask =
  | "classification"
  | "clustering"
  | "ingest"
  | "search";
...
export type InferenceMistralTaskType =
  | "text_embedding"
  | "completion"
  | "chat_completion";
...
export type InferenceTaskTypeAlibabaCloudAI =
  | "text_embedding"
  | "rerank"
  | "completion"
  | "sparse_embedding";
...
export type InferenceTaskTypeAmazonSageMaker =
  | "text_embedding"
  | "completion"
  | "chat_completion"
  | "sparse_embedding"
...
export type InferenceTaskTypeCohere =
  | "text_embedding"
  | "rerank"
  | "completion";

export type InferenceTaskTypeCustom =
  | "text_embedding"
  | "sparse_embedding"
  | "rerank"
  | "completion";
...
export type InferenceTaskTypeElasticsearch =
  | "sparse_embedding"
  | "text_embedding"
  | "rerank";
...
export type InferenceTaskTypeOpenAI =
  | "text_embedding"
  | "chat_completion"
  | "completion";
...
export type InferencePutAmazonsagemakerResponse =
...
export type InferencePutDeepseekResponse =
...
export type InferenceSparseEmbeddingResponse =
  InferenceSparseEmbeddingInferenceResult;
...
export type InferenceTextEmbeddingResponse =
...
export type IngestPipelineSimulationStatusOptions =
  | "success"
  | "error"
  | "error_ignored"
  | "skipped"
...
export interface MlNlpBertTokenizationConfig
  extends MlCommonTokenizationConfig {}
...
export interface MlXlmRobertaTokenizationConfig
  extends MlCommonTokenizationConfig {}
...
export type SearchApplicationEventType =
  | "page_view"
  | "search"
  | "search_click";

export interface SearchApplicationSearchApplication
  extends SearchApplicationSearchApplicationParameters {
  name: Name;
...
export interface SearchApplicationPostBehavioralAnalyticsEventRequest
  extends RequestBase {
...
export type SearchApplicationSearchResponse<TDocument = unknown> =
  SearchResponseBody<TDocument>;
...
export type SimulateIngestIngestDocumentSimulation =
...
export interface SimulateIngestRequest extends RequestBase {
  ...
  body?: {
    docs: IngestDocument[];
    component_template_substitutions?: Record<
      string,
...
export type TextStructureFormatType =
  | "delimited"
  | "ndjson"
